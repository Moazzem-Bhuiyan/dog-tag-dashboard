...
const StatCard = ({
     ...
     return (
          <div className="flex items-center justify-center px-6 py-14 bg-[#C2C3C2] text-black rounded-lg transition-shadow duration-200 gap-10">
               {/* Icon Section */}
               ...
               <div className="text-right flex items-center flex-col justify-center">
                    ...
                    <div className="flex items-end gap-2">
                         ...
                         {growth && (
                              <p className="text-sm text-black flex flex-col items-center justify-end gap-1">
