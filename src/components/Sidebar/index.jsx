...
import Logo from "../../images/logo/doglogo.png";
import {FiShoppingBag} from "react-icons/fi";
import {GoChecklist, GoUpload} from "react-icons/go";
...
const Sidebar = ({sidebarOpen, setSidebarOpen}) => {
     ...
     return (
          <aside
               ref={sidebar}
               className={`relative left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-[#ffffff] duration-300 ease-linear  lg:static lg:translate-x-0 ${
               ...
               <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear ">
                                   ...
                                   <NavLink
                                        ...
                                        className={({isActive}) =>
                                             `group relative flex items-center gap-2.5 rounded-sm py-2 px-8 font-medium text-[#364636] duration-300 ease-in-out ${
                                                  isActive
                                                       ? "bg-[#404140] !text-white before:content-[''] before:absolute before:top-0 before:left-2 before:h-full before:w-3 before:bg-[#FAF1E6]"
                                                       : "hover:bg-[#404140] hover:text-white"
                                             }`
                                        }>
                  ...
                  >
                              ...
                              <SidebarLinkGroup
                                   ...
                                   {(handleClick, open) => (
                                        <>
                                             <NavLink
                                                  to="/#"
                                                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-8 font-medium text-[#364636] duration-300 ease-in-out hover:bg-[#404140] hover:text-white`}
                                                  onClick={(e) => {
                                                       e.preventDefault();
                                                       sidebarExpanded
                                                            ? handleClick()
                                                       ...
                                                       <li>
                                                            <NavLink
                                                                 ...
                                                                 className={({
                                                                      ...
                                                                      "group relative flex items-center hover:!bg-[#404140] hover:!text-white gap-2.5  px-16 py-2  font-medium text-[#364636] duration-300 ease-in-out " +
                                                                      (isActive &&
                                                                           "!bg-[#404140] !text-white before:content-[''] before:absolute before:top-0 before:left-2 before:h-full before:w-3 before:bg-[#FAF1E6]")
                                                                 }>
                                                                 Personal
                                                       ...
                                                       <li>
                                                            <NavLink
                                                                 ...
                                                                 className={({
                                                                      ...
                                                                      "group relative flex items-center gap-2.5 hover:!bg-[#404140] hover:!text-white  px-16 py-2 font-medium text-[#364636] duration-300 ease-in-out " +
                                                                      (isActive &&
                                                                           "!bg-[#404140] !text-white before:content-[''] before:absolute before:top-0 before:left-2 before:h-full before:w-3 before:bg-[#FAF1E6]")
                                                                 }>
                                                                 Terms &
                    ...
                    >
                         ...
                         <p className="text-[#364636] text-base font-medium">
                              Logout
                         </p>
                    </button>
               </div>
